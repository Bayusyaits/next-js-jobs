    ...
    <div className="container offline-page">
       <div className="offline-area-wrapper py-3 d-flex align-items-center justify-content-center">
          <div className="offline-text text-center">
            ...
            <p>Seems like you re offline, please check your internet connection. This page doesnt support when you offline!</p><a className="btn btn-primary" href="home.html">Back Home</a>
          </div>
        </div>
    </div>
  )
